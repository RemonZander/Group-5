...
| |_\ \ | | (_| | | | | (_| | | | | |_| \__ \ | (_) | | | |
 \____/_|  \__,_|_| |_|\__,_| \_|  \__,_|___/_|\___/|_| |_|";
                ...
                switch (Convert.ToInt32(choise))
                {
                    ...
                    case 4:
                        ...
                        else
                        {
                            ...
                            Console.WriteLine("Drunk op een knop om verder te gaan.");
                            Console.ReadKey();
                            return 0;
                        }
                    case 100:
    ...
    public class ReviewScreen : screens
    {
    ...
    public class RegisterScreen : screens
    {
        ...
        public int DoWork()
        {
            ...
            Console.WriteLine(GFLogo);
            Console.WriteLine("Hier kunt u een account aanmaken om reververingen te plaatsen voor GrandFusion en meer!" + "\n");
